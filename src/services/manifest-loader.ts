...
const LAYER_TYPES: LayerType[] = ["global", "domain", "language", "framework", "project"];
...
export class ProjectManifestLoader {
	...
	/**
	 * Loads a project manifest together with the repository path it was read from.
	 */
...
/**
 * Validates and normalizes the optional layer lists from a parsed manifest object.
 */
